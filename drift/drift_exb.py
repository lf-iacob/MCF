...
import EMfield
from EMfield import em_ortho
from EMfield import uniforme
import random
...
v0_x=2*10
v0_y=5*10**2 #m/s (a caso, se mai "vicino" alla velocità della luce)
v0_z=1
...
'''
print(uniforme(E, B, v0_x, v0_y, v0_z, N))   #non so se ho capito la consegna pt6000
print(em_ortho(E, B, q, m, v0_x, v0_y, v0_z, N))
'''
...
for i in range(0,p):
    particles_v0=np.append(particles_v0, [np.random.uniform(low=-700, high=700, size=3)], axis=0)  #dice in intervallo opportuno ma non so cosa significa
